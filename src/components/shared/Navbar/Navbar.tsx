        ...
        <div className="navbar-glass">
          <div className="mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 md:h-20 items-center justify-between">
              ...
              >
                <div className="relative">
                  <div className="absolute inset-0 rounded-full bg-cyan-400/20 blur-xl group-hover:bg-cyan-400/30 transition-all duration-300 md:duration-500" />
                  <div className="relative h-10 w-10 md:h-12 md:w-12 rounded-full overflow-hidden ring-2 ring-cyan-400/50 group-hover:ring-cyan-400 transition-all duration-300 bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center">
                    <Image 
                      src={logo} 
                      alt="Labid Rahat" 
                      fill
                ...
                <div className="flex flex-col">
                  <span className="text-lg md:text-2xl font-bold bg-gradient-to-r from-cyan-400 via-blue-400 to-cyan-300 bg-clip-text text-transparent group-hover:from-cyan-300 group-hover:via-blue-300 group-hover:to-cyan-200 transition-all duration-300">
                    Labid Rahat
                  </span>
                  <span className="text-[10px] md:text-xs text-cyan-400/60 font-light tracking-wider hidden sm:block">
                    World History Storyteller
                  </span>
                </div>
              </Link>
              ...
              <Sheet open={isOpen} onOpenChange={setIsOpen}>
                <SheetTrigger asChild className="lg:hidden">
                  <button
                    className="relative h-10 w-10 md:h-12 md:w-12 flex items-center justify-center rounded-lg border border-cyan-400/30 bg-slate-900/50 backdrop-blur-sm hover:border-cyan-400/50 hover:bg-slate-900/70 transition-all duration-300 active:scale-95"
                    aria-label="Menu"
                  >
                ...
                <SheetContent
                  side="right"
                  className="w-[280px] sm:w-[320px] bg-slate-950/98 backdrop-blur-xl border-l border-cyan-400/20 shadow-2xl shadow-cyan-500/10 p-0 overflow-hidden"
                >
                  <div className="flex flex-col h-full">
                    <div className="flex items-center justify-between px-4 py-4 border-b border-cyan-400/20 bg-slate-900/30">
                      <div className="flex items-center space-x-2.5">
                        <div className="relative">
                          <div className="absolute inset-0 rounded-full bg-cyan-400/20 blur-lg" />
                          <div className="relative h-10 w-10 rounded-full overflow-hidden ring-2 ring-cyan-400/50 bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center">
                            <Image 
                              src={logo} 
                              alt="Labid Rahat" 
                              fill
                        ...
                        <div>
                          <div className="font-bold text-base bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
                            Labid Rahat
                          </div>
                      ...
                      <button
                        onClick={() => setIsOpen(false)}
                        className="h-9 w-9 flex items-center justify-center rounded-lg border border-cyan-400/30 bg-slate-900/50 hover:border-cyan-400/50 hover:bg-slate-900/70 transition-all duration-200 active:scale-95"
                            ...
                            >
                              ...
                              <ChevronRight
                                className={cn(
                                  ...
                                  pathname === item.href
                                    ? "text-cyan-400"
                                    : "text-gray-500 group-hover:text-cyan-400 group-hover:translate-x-0.5"
                                )}
                              />
                            </button>
                          </Link>
                    ...
                    <div className="px-4 py-4 border-t border-cyan-400/20 bg-slate-900/30">
                      <Link
                        href="https://youtube.com/@labidrahat"
                        target="_blank"
                        rel="noopener noreferrer"
